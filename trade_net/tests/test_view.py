...
class ModelsCRUDTestCase(APITestCase):
    ...
    def test_retrieve_unit(self):
        ...
        request = self.client.get(f'/net-unit-retrieve/{NetUnitModel.objects.get(name='Иванов И.И.').id}/')
        self.assertEqual(request.status_code, status.HTTP_200_OK)
    ...
    def test_update_unit(self):
        ...
        request = self.client.patch(f'/net-unit-update/{NetUnitModel.objects.get(name='Иванов И.И.').id}/', data={'email': 'test@mail.com'})
        self.assertEqual(request.status_code, status.HTTP_200_OK)
    ...
    def test_delete_unit(self):
        ...
        requests = self.client.delete(f'/net-unit-destroy/{NetUnitModel.objects.get(name='Иванов И.И.').id}/')
    ...
    def test_update_product(self):
        ...
        ProductModel.objects.create(name='Тестовый продукт',
                                    model='модель тест',
                                    release_date='2025-07-12',
                                    manufacture=NetUnitModel.objects.get(name='Завод бытовой техники'))

        request = self.client.patch(f'/product-update/{ProductModel.objects.get(name='Тестовый продукт').id}/',
    ...
    def test_delete_product(self):
        ...
        ProductModel.objects.create(name='Тестовый продукт 2',
                                    model='модель тест 2',
                                    release_date='2025-07-12',
                                    manufacture=NetUnitModel.objects.get(name='Завод бытовой техники'))

        request = self.client.delete(f'/product-destroy/{ProductModel.objects.get(name='Тестовый продукт 2').id}/')
