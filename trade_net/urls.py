...
urlpatterns = [
    path("net-unit-create/", views.CreateNetUnitView.as_view(), name="net-unit"),
    path(
        "net-unit-retrieve/<int:pk>/",
        views.RetrieveNetUnitView.as_view(),
        name="net-unit-retrieve",
    ),
    path(
        "net-unit-update/<int:pk>/",
        views.UpdateNetUnitView.as_view(),
        name="net-unit-update",
    ),
    path(
        "net-unit-destroy/<int:pk>/",
        views.DestroyNetUnit.as_view(),
        name="net-unit-destroy",
    ),
