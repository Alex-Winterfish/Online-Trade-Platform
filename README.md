...
2. Эндпоинты.
```
    /net-unit-create/ - создание объекта сети
    /net-unit-retrieve/id/ - получение объекта сети
    /net-unit-update/id/ - изменение объекта сети
    /net-unit-destroy/id/ - удаление объекта сети
    /net-unit-list/ - получение списка объектов сети
    /product-create/ - создание продукта
    /product-retrieve/id/ - получение продукта
    /product-update/id/ - изменение продукта
    /product-destroy/id/ - удаление продукта
    /product-list/ - получение списка продуктов
```
3. Сериализация.
...
Нас странице объекта NetUnitModel имеется ссылка на поставщика.
...
TOTAL                                    429     37    91%
```
Отчет о покрытии тестами сохранен в coverage.html
